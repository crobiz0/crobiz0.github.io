...
<div id="top"></div> 
    ...
    <main>
        ...
        <center>
        <form action="noticias.php" method="GET" class="buscador" onsubmit="buscarNoticias(); return false;">
        ...
        <?php if ($resultado->num_rows > 0): ?> <!--muestra la lista de noticicas con su estructura y enlaces para leer mas
            si no hay noticias mestra mensaje-->
            ...
            <div class="imagen-noticia">
                ...
                ?>
                <img src="data:image/jpeg;base64,<?php echo $imagenBase64; ?>" alt="Imagen de noticia" />
            </div>
